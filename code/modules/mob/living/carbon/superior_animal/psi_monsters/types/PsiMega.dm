/mob/living/carbon/superior_animal/psi_monster/dreaming_king
	name = "Dreaming King"
	desc = "The Dreaming King, named by the first psion who saw it through a drug induced haze. Thought first to be merely the creation of a fever dream until alsahras into deep maintenance revealed him \
