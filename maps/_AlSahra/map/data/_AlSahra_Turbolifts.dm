/obj/turbolift_map_obj/turbolift_map_base/alsahra/ElevOne
	name = "Turbolift"
...
/*
/obj/turbolift_map_obj/turbolift_map_base/alsahra/ElevTwo
	name = "Turbolift"
	lift_size_x = 3 // Size of the actual lift, shaft walls are extra.
	lift_size_y = 3
	icon = 'icons/modules/turbolift/turbolift_preview_3x3 - no walls.dmi'
...
//MINING ELEVATOR
/obj/turbolift_map_obj/turbolift_map_base/alsahra/Mining
	name = "Turbolift"
	lift_size_x = 3 // Size of the actual lift, shaft walls are extra.
	lift_size_y = 3
	icon = 'icons/modules/turbolift/turbolift_preview_3x3 - no walls.dmi'
...
/area/turbolift/Mining/underground
	name = "alsahra Mining - Mining"
	lift_floor_label = "alsahra Mining"
...
/area/turbolift/Mining/colony
	name = "alsahra Mining - Colony"
	lift_floor_label = "alsahra Colony"
	lift_floor_name = "Colony"
	lift_announce_str = "Transition complete. Welcome to the alsahra Colony Underground."
	base_turf = /turf/simulated/shuttle/floor/mining


//PROSPECTOR ELEVATOR
/obj/turbolift_map_obj/turbolift_map_base/alsahra/prospector
	name = "Turbolift"
	lift_size_x = 3 // Size of the actual lift, shaft walls are extra.
	lift_size_y = 3
	icon = 'icons/modules/turbolift/turbolift_preview_3x3 - no walls.dmi'
...
/area/turbolift/prospector/underground
	...
	lift_announce_str = "Transition complete. Welcome to the alsahra Underground. Be mindful of all longarm firearm regulations."
	base_turf = /turf/simulated/shuttle/floor/mining
...
/area/turbolift/prospector/surface
	...
	lift_announce_str = "Transition complete. Welcome to the alsahra Surface. Be mindful of all longarm firearm regulations."
	base_turf = /turf/simulated/shuttle/floor/mining

//SOLARS ELEVATOR
/obj/turbolift_map_obj/turbolift_map_base/alsahra/mountaintop
	name = "Turbolift"
	lift_size_x = 3 // Size of the actual lift, shaft walls are extra.
	lift_size_y = 3
	icon = 'icons/modules/turbolift/turbolift_preview_3x3 - no walls.dmi'
...
/area/turbolift/Research/underground
	name = "alsahra Research - Underground"
	lift_floor_label = "alsahra Research"
...
//colony
/area/turbolift/ElevatorOne/underground
	name = "alsahra Underground"
	lift_floor_label = "alsahra Underground"
	lift_floor_name = "Floor Two"
	lift_announce_str = "Transition complete. Welcome to the alsahra Underground."
	base_turf = /turf/simulated/shuttle/floor/mining
...
/area/turbolift/ElevatorOne/surface
	name = "alsahra Surface"
	lift_floor_label = "alsahra Surface"
